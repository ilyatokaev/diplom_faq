...
require_once './templates/question_without_answer_del_form.php';
require_once './templates/question_edit_form.php';
require_once './templates/question_without_answer_edit_form.php';
...
require_once './Controller/Show_question_without_answer_del_form.php';
require_once './Controller/Question_del_action.php';
require_once './Controller/Question_without_answer_del_action.php';
require_once './Controller/Show_question_edit_form.php';
require_once './Controller/Show_question_without_answer_edit_form.php';
require_once './Controller/Question_update_action.php';
require_once './Controller/Question_without_answer_update_action.php';
